...
export const FilterIcon: FC<Props> = ({width = 16, height = 16}) => {
  return (
    <svg
      width={width}
      height={height}
...
export const EnterIcon: FC<Props> = ({width = 16, height = 16}) => {
  return (
    <svg
      width={width}
      height={height}
...
export const StarsIcon: FC<Props> = ({width = 16, height = 16}) => {
  return (
    <svg
      width={width}
      height={height}
...
export const StatisticsIcon: FC<Props> = ({width = 16, height = 16}) => {
  return (
    <svg
      width={width}
      height={height}
...
export const UpwardsIcon: FC<Props> = ({width = 16, height = 16}) => {
  return (
    <svg
      width={width}
      height={height}
...
export const DownwardsIcon: FC<Props> = ({width = 16, height = 16}) => {
  return (
    <svg
      width={width}
      height={height}
...
export const IdentificationIcon: FC<Props> = ({width = 16, height = 16}) => {
  return (
    <svg
      width={width}
      height={height}
...
export const InfoIcon: FC<Props> = ({width = 16, height = 16}) => {
  return (
    <svg
      width={width}
      height={height}
...
export const ImageIcon: FC<Props> = ({width = 16, height = 16}) => {
  return (
    <svg
      width={width}
      height={height}
...
export const BackIcon: FC<Props> = ({width = 16, height = 16, onClick}) => {
  return (
    <svg
      onClick={onClick}
      width={width}
