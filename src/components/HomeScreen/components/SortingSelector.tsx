...
export const SortingSelector = () => {
  ...
  return (
    <div className="basis-[30%] small:w-[60vw] small:min-w-[350px] min-w-[250px] my-0 rounded-none rounded-tr-md small:rounded-tr-none small:rounded-tl-md select-none flex justify-between px-0 shadow-book-reverse-box small:shadow-book-box small:hover:shadow-book-box-hover hover:shadow-book-reverse-box-hover hover:scale-102 transition-all">
      {searchType === 'subject' ? (
