...
export const SearchTypeSelector = () => {
  ...
  return (
    <div className="basis-[30%] min-w-[250px] small:hidden small:w-full small:min-w-[300px] select-none my-0 rounded-none rounded-tl-md flex justify-between px-0 shadow-book-box hover:shadow-book-box-hover hover:scale-102 transition-all">
