  ...
  if (!text) {
    ...
    return (
      <div className="w-full h-full group relative">
        ...
        <div
          ref={ref}
          className="absolute group-hover:opacity-100 hover:opacity-100 opacity-0 pointer-events-none rounded-md hover:pointer-events-auto text-center justify-center items-center -left-[50%] top-[calc(100%+8px)] transition-all bg-white  shadow-book-result-hover">
          <div
            ref={indicatorRef}
